...
#회원 테이블 생성CREATE TABLE `board_user` (
	...
	`regip`	VARCHAR(100),	
	`rdate`	DATETIME			
);FLUSH PRIVILEGES;FLUSH PRIVILEGES;GRANT ALL PRIVILEGES ON `java1_board`.* TO 'java1_board'@'%';CREATE USER 'java1_board'@'%' IDENTIFIED BY '1234';#날짜 : 2022/10/18
#이름 : 홍민준
#내용 : 게시판 서비스 테이블 설계
