...
insert into `doctors` values('D108101','송상현','1997-03-14','M','108','과장','010-8101-1977','ssh@bw.com');

#Nurse
insert into `nurse` values('N101101','송승헌','1976-02-21','M','101','수간호사','010-1101-7602','ssh@bw.com');
insert into `nurse` values('N102101','이영애','1975-07-11','F','102',' 수간호사','010-1101-7507','yung@bw.com');
