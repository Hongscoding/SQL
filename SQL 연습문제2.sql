...
insert into `bank_customer` values ('750210-1000002', '감춘추' , 1,'010-1234-1002' , '경기도 광주시');
...
insert into `bank_account` values('101-11-1003', 'S1', '자유저축예금', '870830', 53000,'2007-02-17' );
...
insert into `bank_transaction` values( 4, '101-11-1002',  1,  1000000,now());
